...
from model import VGG16Perceptual, EncoderF, EncoderZF, DCGAN_D, EncoderZ 
import numpy as np
import random
...
def parse():
    ...
    parser.add_argument('--interval_save', type=int, default=30)
...
def main(args):
    print(args)
    log_name = make_log_name(args, 'encoder_zf')
        ...
        for i, (x, _) in enumerate(tqdm(dataloader)):
            ...
            if i % args.interval_save == 0:
                ...
                with torch.no_grad():
                    ...
                    writer.flush()
                    torch.save(encoder.state_dict(), './encoder_zf.ckpt') 
