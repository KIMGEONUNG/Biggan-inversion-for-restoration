...
def main(args):
    ...
    encoder_f = EncoderF(in_ch).to(DEV)
    encoder_z = EncoderZ(in_ch).to(DEV)
    ...
    opt_target = []
    opt_target += list(encoder_f.parameters())
    opt_target += list(encoder_z.parameters())
